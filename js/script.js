...
class Library {
    ...
    deleteBook(uuidToDelete) {
        const indexToDelete = this.library.findIndex(item => 
...
class Book {
    constructor (name, author, description, year, isRead) {
...
function renderBooks() {
    ...
    myLibrary.books.forEach(book => {
        ...
        isBookReadBtn.addEventListener('click', (e) => {
            const indexToToggle = myLibrary.books.findIndex(item => 
                item.uuid === book.uuid);
            myLibrary.books[indexToToggle].toggleRead();
            renderBooks();
        })

        removeBook.addEventListener('click', (e) => {
            myLibrary.deleteBook(book.uuid);
        })
